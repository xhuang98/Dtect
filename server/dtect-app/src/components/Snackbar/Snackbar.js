...
export default function Snackbar(props) {
  ...
  if (close !== undefined) { action = [snackBarClose(classes, props)];}
  return (
    <Snack
      anchorOrigin={{
      ...
      action={action}
      ContentProps={{classes: {root: classes.root + " " + classes[color], message: classes.message}}}
    />
  );
}

export function snackBarClose(classes, props){
  return (
      <IconButton
